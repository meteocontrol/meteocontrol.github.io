...
| datapoints    | `M_AC_EQ_CAP`          | kvarh  | Total Reactive Energy capacitive (Sum of Export and Import) |       |          |                              |         |
...
| datapoints    | `M_AC_EQ_IND`          | kvarh  | Total Reactive Energy inductive (Sum of Export and Import)  |       |          |                              |         |
...
| datapoints    | `M_AC_OT_TOTAL`        | h      | Operation Time TOTAL                                        |       |          |                              |         |
